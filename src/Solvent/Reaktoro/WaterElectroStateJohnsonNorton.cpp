...
inline auto k0(ThermoScalar t)    -> ThermoScalar { return {1.0, 0.0, 0.0, 0.0}; }
...
inline auto k0_t(ThermoScalar t)  -> ThermoScalar { return {0.0, 0.0, 0.0, 0.0}; }
...
inline auto k0_tt(ThermoScalar t) -> ThermoScalar { return {0.0, 0.0, 0.0, 0.0}; }
