...
/// @param bso bson object
auto thermoParamSubst (const std::string& data, std::string name) -> ThermoParametersSubstance;
auto thermoParamSubst (const std::string& data, std::string name, std::string prop_name, ThermoParametersSubstance& ps) -> void;
...
/// @param bso bson object
auto thermoRefPropReac (const std::string& data, std::string name) -> ThermoPropertiesReaction;
