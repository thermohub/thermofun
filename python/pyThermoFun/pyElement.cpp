...
void exportElement(py::module& m)
{
    py::class_<Element>(m, "Element")
        ...
        .def("setNumber", &Reaction::setNumber, "Return the Mendeleev table number of the element")
        ...
        .def("number", &Reaction::number, "Return the Mendeleev table number of the element")
