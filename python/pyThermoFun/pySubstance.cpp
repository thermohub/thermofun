...
void exportSubstance(py::module& m)
{
    py::class_<Substance>(m, "Substance")
        ...
        .def("setReactionSymbol", &Substance::setReactionSymbol, "Set the name of the reaction that defines the substance properties.")
        ...
        .def("setCharge", &Substance::setCharge)
        .def("setReferenceT", &Substance::setReferenceT)
        .def("setReferenceP", &Substance::setReferenceP)
        ...
        .def("reactionSymbol", &Substance::reactionSymbol, "Return the reaction name that defines the properties of the chemical Substance")
        ...
        .def("aggregateState", &Substance::aggregateState)
        .def("charge", &Substance::charge)
        ;
}
