...
void exportDatabase(py::module& m)
{
    ...
    auto appendData2 = static_cast<void(Database::*)(std::vector<std::string>)>(&Database::appendData);
    ...
    py::class_<Database>(m, "Database")
        ...
        .def("setElement", &Database::setElement, "Sets a Element in the database. If substance exists the record will be overwriten")
        ...
        .def("setSubstance", &Database::setSubstance, "Sets a substance in the database. If substance exists the record will be overwriten")
        ...
        .def("setReaction", &Database::setReaction, "Sets a reaction in the database. If reaction exists the record will be overwriten")
        ...
        .def("numberOfElements", &Database::numberOfElements, "Returns the number of elements in the databse")
        .def("numberOfSubstances", &Database::numberOfSubstances, "Returns the number of substances in the databse")
