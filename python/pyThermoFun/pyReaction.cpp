...
void exportReaction(py::module& m)
{
    py::class_<Reaction>(m, "Reaction")
        ...
        .def("setReferenceP", &Reaction::setReferenceP,"Set references pressure for the standard proeprties of reaction (Pa)")
        ...
        .def("thermo_ref_prop", &Reaction::thermo_ref_prop,"Returns the references proeprties of the reaction")
        .def("thermo_parameters", &Reaction::thermo_parameters,"Returns an instance of the defined parameters of the reaction")
