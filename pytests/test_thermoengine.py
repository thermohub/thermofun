...
class TestThermoEngine(unittest.TestCase):
    ...
    def test_properties_reaction_from_equation(self):
        ...
        assert self.engine.thermoPropertiesReaction(423.15, 0, "Cal = Ca+2 + CO3-2").log_equilibrium_constant.val == pytest.approx(-10.10141, 1e-5, 1e-14)
    ...
    def test_properties_reaction(self):
        ...
        assert self.engine2.thermoPropertiesReaction(423.15, 0, "Meionite-Ca").log_equilibrium_constant.val == pytest.approx(28.23, 1e-5, 1e-14)
